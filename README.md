...
Filenames use the [Pokémon Showdown](https://pokemonshowdown.com/) name format — lowercase, spaces and underscores replaced with hyphens, punctuation stripped:

| Pokémon | URL |
|---------|-----|
| Pikachu | `sprites/pikachu.png` |
| Raichu-Alola | `sprites/raichu-alola.png` |
| Charizard-Mega-X | `sprites/charizard-mega-x.png` |
| Mr. Rime | `sprites/mr-rime.png` |
| Vivillon (Poké Ball) | `sprites/vivillon-pokeball.png` |

120×120px PNG thumbnails (~359 total).
